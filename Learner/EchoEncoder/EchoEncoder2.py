# This script is run as the second part of the EchoEncoder algorithm.
# It trains a Naive Bayes classifier on the pre_training set and uses
# it to create echo strings for the test set.
...
X_reply_1_test_counts = count_vect.transform(test_replies_1)
X_reply_2_train_counts = count_vect.transform(training_replies_2)
X_reply_2_test_counts = count_vect.transform(test_replies_2)
X_reply_3_train_counts = count_vect.transform(training_replies_3)
X_reply_3_test_counts = count_vect.transform(test_replies_3)
X_reply_4_train_counts = count_vect.transform(training_replies_4)
X_reply_4_test_counts = count_vect.transform(test_replies_4)
X_reply_5_train_counts = count_vect.transform(training_replies_5)
X_reply_5_test_counts = count_vect.transform(test_replies_5)
...
X_reply_1_test_tfidf = tfidf_transformer.transform(X_reply_1_test_counts)
X_reply_2_train_tfidf = tfidf_transformer.transform(X_reply_2_train_counts)
X_reply_2_test_tfidf = tfidf_transformer.transform(X_reply_2_test_counts)
X_reply_3_train_tfidf = tfidf_transformer.transform(X_reply_3_train_counts)
X_reply_3_test_tfidf = tfidf_transformer.transform(X_reply_3_test_counts)
X_reply_4_train_tfidf = tfidf_transformer.transform(X_reply_4_train_counts)
X_reply_4_test_tfidf = tfidf_transformer.transform(X_reply_4_test_counts)
X_reply_5_train_tfidf = tfidf_transformer.transform(X_reply_5_train_counts)
X_reply_5_test_tfidf = tfidf_transformer.transform(X_reply_5_test_counts)
...
reply_1_pred = clf.predict(X_reply_1_test_tfidf)
reply_2_pred = clf.predict(X_reply_2_test_tfidf)
reply_3_pred = clf.predict(X_reply_3_test_tfidf)
reply_4_pred = clf.predict(X_reply_4_test_tfidf)
reply_5_pred = clf.predict(X_reply_5_test_tfidf)
...
result_zip = zip(test_categories, quin_labels)

# Append the labels and associated echo_strings to the file created in the previous script 
with open('EchoStrings.csv', 'a') as csvfile:
